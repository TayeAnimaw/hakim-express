...
class Settings:
    ...
    # Database URL with a default fallback
    ...
    # Database URL - use PostgreSQL in production (Render), SQLite in development
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./hakim_express.db")
